...
def load_settings ():#line:117
    ...
    print (f"{LIGHT_WHITE}Pick {LIGHT_PURPLE}original jitter(Jitter May Be Stronger Then Option {LIGHT_WHITE}[1]\033[0m {LIGHT_WHITE}[{LIGHT_CYAN}2{LIGHT_WHITE}]")#line:120
